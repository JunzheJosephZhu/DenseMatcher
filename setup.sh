...
pip install ipympl triton transformers matplotlib
pip install -e .
...
pip install trimesh rtree "pyglet<2" plyfile meshio robust_laplacian potpourri3d open3d pywavefront

# override some versions
pip install pytorch-lightning==1.9.5 kornia==0.7.2 pillow==9.3.0 transformers==4.27.0 #for compatibility with sdkit and detectron
